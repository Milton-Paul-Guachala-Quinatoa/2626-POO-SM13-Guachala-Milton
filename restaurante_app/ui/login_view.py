...
class LoginView(tk.Frame):
    ...
    def definir_estilos(self):
        ...
        estilo.configure("Login.TButton", background="#dc2626", foreground="#ffffff",
                         font=("Arial", 11, "bold"), padding=(14, 8), borderwidth=0)
        estilo.map("Login.TButton", background=[("active", "#dc2626")])

    def construir_interfaz(self):
        contenedor = tk.Frame(self, bg="#ffffff", padx=32, pady=28)
        contenedor.place(relx=0.5, rely=0.5, anchor="center")

        tk.Label(contenedor, text="Restaurante App", bg="#ffffff", fg="#1f2a44",
                 font=("Arial", 22, "bold")).pack(pady=(0, 6))
        tk.Label(contenedor, text="Inicio de sesion", bg="#ffffff", fg="#516173",
                 font=("Arial", 11)).pack(pady=(0, 22))

        tk.Label(contenedor, text="Usuario", bg="#ffffff", fg="#243447",
                 font=("Arial", 10, "bold")).pack(anchor="w")
        self.usuario_entry = tk.Entry(contenedor, width=30, font=("Arial", 11))
        self.usuario_entry.pack(pady=(4, 14), ipady=4)
        self.usuario_entry.focus()

        tk.Label(contenedor, text="Contrasena", bg="#ffffff", fg="#243447",
                 font=("Arial", 10, "bold")).pack(anchor="w")
